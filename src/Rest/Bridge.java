...
public class Bridge {
    ...
    public static class Mecha extends Npc {

        int attackStrength, speed;

        public Mecha(String name, String threeDimensionalModel, int x, int y, int z, int hp, int attackStrength, int speed) {
    ...
    public static class Kaiju extends Npc {

        int attackStrength, speed, defense;

        public Kaiju(String name, String threeDimensionalModel, int x, int y, int z, int hp, int attackStrength, int speed) {
            super(name, threeDimensionalModel, x, y, z, hp);
            this.attackStrength = attackStrength;
            this.speed = speed;
        }
